...
#ifndef __PACCHETTO_M_H
#define __PACCHETTO_M_H
...
class Packet;
/**
 * Class generated from <tt>MESSAGGIO/pacchetto.msg:1</tt> by opp_msgtool.
 * <pre>
 * message Packet
 * {
 *     double size;

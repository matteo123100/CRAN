//
// Generated file, do not edit! Created by opp_msgtool 6.0 from MESSAGGIO/pacchetto.msg.
//
...
int Packet::getCell() const
{
    return this->cell;
}

void Packet::setCell(int cell)
{
    this->cell = cell;
}
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "cell") == 0) return baseIndex + 1;
...
std::string PacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_cell: return long2string(pp->getCell());
...
void PacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_cell: pp->setCell(string2long(value)); break;
...
omnetpp::cValue PacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_cell: return pp->getCell();
...
void PacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_cell: pp->setCell(omnetpp::checked_int_cast<int>(value.intValue())); break;
